...
### Spring Security
Todas las rutas del backend requieren autenticación excepto `/api/auth/login`. La configuración de seguridad deshabilita CSRF (no necesario en APIs REST stateless).
